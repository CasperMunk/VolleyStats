 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', $secrets['deploy_key']);
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/CasperMunk/VolleyStats');
 ...
 */
define('TARGET_DIR', '/var/www/volleyapp.net/dk/volleystats/');
 ...
 */
define('EMAIL_ON_ERROR', 'caspermunk@gmail.com');