...
?>
    ...
    <p>Der indsamles kun data for VolleyLigaen (inkl. slutspil, playdown og kvalifikation) og kun kampe som er færdigspillede. Pokal-kampe er pt. ikke med, men kommer det måske på et senere tidspunkt. Data for den indeværende sæson opdateres en gang i døgnet. Data fra tidligere sæsoner opdateres ved lejlighed.
    </p>
...
<!--     <p>
    ...
    ?>
    <p>
        I databasen findes der i øjeblikket <b><?php echo $stats['seasons']; ?></b> sæsoner, <!-- <b><?php echo $stats['competitions']; ?></b> turneringer, --><b><?php echo $stats['teams']; ?></b> hold, <b><?php echo $stats['players']; ?></b> spillere, <b><?php echo $stats['games']; ?></b> kampe og <b><?php echo $stats['player_stats']; ?></b> statistik-linjer.
    </p>
